...
HalfStepEulerDdtScheme<Type>::fvcDdt
(
    const dimensioned<Type>& dt
)
{
    dimensionedScalar rDeltaT = 0.5/mesh().time().deltaT();
...
)
{
    ...
    scalar rDeltaT = 0.5/mesh().time().deltaTValue();
...
template<class Type>
tmp<typename HalfStepEulerDdtScheme<Type>::fluxFieldType>
HalfStepEulerDdtScheme<Type>::fvcDdtUfCorr
(
...
template<class Type>
tmp<typename HalfStepEulerDdtScheme<Type>::fluxFieldType>
HalfStepEulerDdtScheme<Type>::fvcDdtPhiCorr
(
    const GeometricField<Type, fvPatchField, volMesh>& U,
...
template<class Type>
tmp<surfaceScalarField> HalfStepEulerDdtScheme<Type>::meshPhi
(
